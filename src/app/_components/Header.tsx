        ...
        <div className="fixed w-full bg-background">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8 border-b dark:border-b-slate-900">
                ...
                <div className="hidden lg:flex lg:flex-row">
                    ...
                    <Button
                        type="button"
                        className="rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black dark:bg-white dark:text-black"
                    >
                        ...
                        <div className="divide-y-2 divide-gray-50 rounded-lg bg-background shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="px-5 pb-6 pt-5">
                                <div className="flex items-center justify-between">
                                    <div className="sm:block lg:hidden inline-flex items-center space-x-2">
                                        <span>
                                            <svg
                                                width="30"
                                                height="30"
                                        ...
                                        <span className="font-bold">Tawha</span>
                                    </div>
                                    <div className="-mr-2">
                                        <button
                                            type="button"
